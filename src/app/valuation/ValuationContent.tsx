                            ...
                            >
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center">
                                        ...
                                        <div>
                                            <h4 className="font-semibold text-slate-900">RedBook</h4>
                                            <p className="text-sm text-slate-600">Australia's leading vehicle valuation guide</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center">
                                        <div className="w-12 h-12 bg-emerald-100 rounded-lg flex items-center justify-center mr-4">
                                            <span className="text-emerald-600 font-bold">GG</span>
                                        </div>
                                        <div>
                                            <h4 className="font-semibold text-slate-900">Glass's Guide</h4>
                                            <p className="text-sm text-slate-600">Comprehensive automotive data and valuations</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center">
                                        <div className="w-12 h-12 bg-teal-100 rounded-lg flex items-center justify-center mr-4">
                                            <span className="text-teal-600 font-bold">MD</span>
                                        </div>
                                        <div>
                                            <h4 className="font-semibold text-slate-900">Market Data</h4>
                                            <p className="text-sm text-slate-600">Real-time Australian automotive market trends</p>
                                        </div>
                                    </div>
                                </div>
                            </motion.div>
